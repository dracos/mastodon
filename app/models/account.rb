...
class Account < ApplicationRecord
  ...
  GRAPHEME_RE = /[\u{1F3FB}-\u{1F3FF}](?=[\u{1F3FB}-\u{1F3FF}])|(?:[^\u{10000}-\u{10FFFF}][\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]?|[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|(?:[\u{1F1E6}-\u{1F1FF}]){2}|[\u{10000}-\u{10FFFF}])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|[\u{1F3FB}-\u{1F3FF}])?(?:\u200d(?:[^\u{10000}-\u{10FFFF}]|(?:[\u{1F1E6}-\u{1F1FF}]){2}|[\u{10000}-\u{10FFFF}])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|[\u{1F3FB}-\u{1F3FF}])?)*/
